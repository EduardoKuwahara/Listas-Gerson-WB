...
export default class ConsumidoGenero extends Listagem {
    ...
    public listar(): void {
        ...
        console.log();
        console.log(`Produto mais consumido pelo sexo Masculino`);
        ...
        console.log();
        console.log(`Serviço mais consumido pelo sexo Masculino`);
        ...
        console.log();
        console.log(`Produto mais consumido pelo sexo Feminino`);
        ...
        console.log();
        console.log(`Servico mais consumido pelo sexo Feminino`);
